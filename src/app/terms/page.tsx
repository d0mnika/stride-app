      ...
      <div className="max-w-3xl mx-auto px-6 pt-10 pb-16">
        ...
        <div className="space-y-8 text-[#5C4A45] text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">
              Stride offers a free tier and a paid Pro subscription. The features included in each
              tier are described on the pricing page and within the app.
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Subscriptions are billed monthly (or as stated at checkout) via Stripe.</li>
              <li>You can cancel your subscription at any time through the Account page. Cancellation takes effect at the end of the current billing period.</li>
          ...
          <section>
            <h2 className="font-palatino text-xl font-bold text-[#3D2B26] mb-3">5. Acceptable use</h2>
          ...
          <section>
            <h2 className="font-palatino text-xl font-bold text-[#3D2B26] mb-3">6. AI features</h2>
            <p>
          ...
          <section>
            <h2 className="font-palatino text-xl font-bold text-[#3D2B26] mb-3">7. Intellectual property</h2>
            <p>
          ...
          <section>
            <h2 className="font-palatino text-xl font-bold text-[#3D2B26] mb-3">8. Disclaimer of warranties</h2>
            <p>
          ...
          <section>
            <h2 className="font-palatino text-xl font-bold text-[#3D2B26] mb-3">9. Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-palatino text-xl font-bold text-[#3D2B26] mb-3">10. Termination</h2>
            <p>
              We may suspend or terminate your account if you violate these terms or if we discontinue
              the service. You may delete your account at any time by contacting us. On termination,
              your data will be deleted as described in our Privacy Policy.
            </p>
          </section>

          <section>
            <h2 className="font-palatino text-xl font-bold text-[#3D2B26] mb-3">11. Governing law</h2>
            <p>
          ...
          <section>
            <h2 className="font-palatino text-xl font-bold text-[#3D2B26] mb-3">12. Contact</h2>
            <p>
